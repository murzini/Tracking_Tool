...
// as midnight UTC, so the `to` day must be taken through its END (23:59:59.999) and
// both bounds parsed as LOCAL time (append a time component) — otherwise a `to` of
// "today" closes the window at the start of the day and discards the whole day's
// capture.
