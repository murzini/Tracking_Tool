...
// Resolve the internal sampling rate: query-param override → env → default 100%.
export function resolveSamplingRate(search) {
...
export function resolveSamplingDecision(search) {
  const rate = resolveSamplingRate(search);
